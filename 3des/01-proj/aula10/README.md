...
- (08/12/2023) Entrega do prototipo em funcionamento
    - Funcionalidades **essenciais**
    - Funcionalidades importantes
    - Funcionalidades desejáveis
- (11, 12, 13, 14 e 15/12/2023) Apresentações dos projetos aos professores, alunos, coordenação e/ou empreendedores
- (15/12/2023) Entrega do documento do projeto versão final (PDF)
...
- Capítulo IV Orçamento
    - Custo de cada requisito funcional (Baseado na hora de cada programador)
    - Custo dos requisitos não funcionais (implantação, hospedagem, domínio...)
    - Custo total
