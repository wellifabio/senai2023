...
compras[0].parcelas.push(parcelas[0])
compras[0].parcelas.push(parcelas[1])
compras[0].parcelas.push(parcelas[2])
compras[0].parcelas.push(parcelas[3])
compras[1].parcelas.push(parcelas[4])
compras[1].parcelas.push(parcelas[5])
compras[2].parcelas.push(parcelas[6])
compras[2].parcelas.push(parcelas[7])
compras[2].parcelas.push(parcelas[8])
compras[3].parcelas.push(parcelas[9])
compras[3].parcelas.push(parcelas[10])
compras[3].parcelas.push(parcelas[11])
compras[3].parcelas.push(parcelas[12])
compras[3].parcelas.push(parcelas[13])
